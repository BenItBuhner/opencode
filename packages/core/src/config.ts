...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const names = ["opencode.json", "opencode.jsonc", "opengoal.json", "opengoal.jsonc"]
    ...
    const discovered = locationIsGlobal
      ...
      : yield* fs
          .up({
            targets: [".opencode", ".opengoal", ...names.toReversed()],
...
function isConfigDirectory(item: string) {
  return path.basename(item) === ".opencode" || path.basename(item) === ".opengoal"
}
