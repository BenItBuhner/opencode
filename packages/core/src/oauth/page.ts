...
// OpenGoal wordmark — same path geometry as packages/ui/src/components/logo.tsx (Logo).
const WORDMARK = `<svg class="wordmark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 234 42" fill="none" aria-label="OpenGoal" role="img">
        ...
        <path d="M138 30H126V12H138V18H132V24H138V30Z" fill="var(--oc-icon-weak)" />
        <path d="M120 6H144V12H120V6ZM120 6H126V36H120V6ZM120 30H144V36H120V30ZM138 18H144V36H138V18ZM132 18H144V24H132V18Z" fill="var(--oc-icon-strong)" />
        ...
        <path d="M198 30H186V12H198V30Z" fill="var(--oc-icon-weak)" />
        <path d="M186 6H204V12H186V6ZM180 12H186V30H180V12ZM198 6H204V36H198V6ZM186 30H204V36H186V30Z" fill="var(--oc-icon-strong)" />
        <path d="M234 30H216V18H234V30Z" fill="var(--oc-icon-weak)" />
        <path d="M210 6H216V36H210V6ZM210 30H234V36H210V30Z" fill="var(--oc-icon-strong)" />
      </svg>`
