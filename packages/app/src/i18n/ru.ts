export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от OpenGoal",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в OpenGoal.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в OpenGoal.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в OpenGoal.",
  ...
  "dialog.server.description": "Переключите сервер OpenGoal к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверка OpenGoal...",
  "wsl.onboarding.checkingOpencodeIn": "Проверка OpenGoal в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Обновление OpenGoal...",
  "wsl.onboarding.updatingOpencodeIn": "Обновление OpenGoal в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Обновите OpenGoal в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Обновить OpenGoal",
  "wsl.onboarding.opencodeReadyIn": "OpenGoal в {{distro}} готов к работе.",
  "wsl.onboarding.opencodeReady": "OpenGoal готов к работе.",
  "wsl.onboarding.installOpencodeIn": "Установите OpenGoal в {{distro}}.",
  "wsl.onboarding.installOpencode": "Установить OpenGoal",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenGoal не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в OpenGoal требуется WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "OpenGoal не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте OpenGoal.",
  ...
  "toast.update.description": "Новая версия OpenGoal ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде OpenGoal",
  ...
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что OpenGoal пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "OpenGoal включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер OpenGoal внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения OpenGoal",
  ...
  "settings.general.row.appearance.description": "Настройте как OpenGoal выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли OpenGoal системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление OpenGoal.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске OpenGoal",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию OpenGoal.",
