export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez OpenGoal",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w OpenGoal.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w OpenGoal.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w OpenGoal.",
  ...
  "dialog.server.description": "Przełącz serwer OpenGoal, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie OpenGoal...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie OpenGoal w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie OpenGoal...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie OpenGoal w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj OpenGoal w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj OpenGoal",
  "wsl.onboarding.opencodeReadyIn": "OpenGoal jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "OpenGoal jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj OpenGoal w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj OpenGoal",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenGoal nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim OpenGoal będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "OpenGoal nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz OpenGoal.",
  ...
  "toast.update.description": "Nowa wersja OpenGoal ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu OpenGoal",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: OpenGoal nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "OpenGoal zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer OpenGoal wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla OpenGoal",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd OpenGoal na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy OpenGoal ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw OpenGoal.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania OpenGoal",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji OpenGoal.",
