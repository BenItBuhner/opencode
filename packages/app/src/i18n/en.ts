export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by OpenGoal",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in OpenGoal.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in OpenGoal.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in OpenGoal.",
  ...
  "dialog.server.description": "Switch which OpenGoal server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking OpenGoal...",
  "wsl.onboarding.checkingOpencodeIn": "Checking OpenGoal in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating OpenGoal...",
  "wsl.onboarding.updatingOpencodeIn": "Updating OpenGoal in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update OpenGoal in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update OpenGoal",
  "wsl.onboarding.opencodeReadyIn": "OpenGoal is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "OpenGoal is ready.",
  "wsl.onboarding.installOpencodeIn": "Install OpenGoal in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install OpenGoal",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenGoal not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before OpenGoal can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "OpenGoal could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen OpenGoal.",
  ...
  "toast.update.description": "A new version of OpenGoal ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the OpenGoal team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, OpenGoal does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "OpenGoal includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the OpenGoal server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for OpenGoal",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how OpenGoal looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether OpenGoal follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how OpenGoal is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when OpenGoal launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of OpenGoal.",
