export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo OpenGoal",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no OpenGoal.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no OpenGoal.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no OpenGoal.",
  ...
  "dialog.server.description": "Trocar para qual servidor OpenGoal este aplicativo se conecta.",
  ...
  "wsl.onboarding.step.opencode": "OpenGoal",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o OpenGoal...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o OpenGoal em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o OpenGoal...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o OpenGoal em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o OpenGoal em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o OpenGoal",
  "wsl.onboarding.opencodeReadyIn": "O OpenGoal está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O OpenGoal está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o OpenGoal em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o OpenGoal",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenGoal não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o OpenGoal possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O OpenGoal não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o OpenGoal novamente.",
  ...
  "toast.update.description": "Uma nova versão do OpenGoal ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do OpenGoal",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: OpenGoal ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "OpenGoal inclui modelos gratuitos para você começar imediatamente.",
  ...
  "app.name.desktop": "OpenGoal Desktop",
  ...
  "settings.desktop.wsl.description": "Executar o servidor OpenGoal dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do OpenGoal",
  ...
  "settings.general.row.appearance.description": "Personalize como o OpenGoal aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o OpenGoal segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o OpenGoal é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o OpenGoal iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do OpenGoal.",
