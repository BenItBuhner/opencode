export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par OpenGoal",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans OpenGoal.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans OpenGoal.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans OpenGoal.",
  ...
  "dialog.server.description": "Changez le serveur OpenGoal auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'OpenGoal...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'OpenGoal dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'OpenGoal...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'OpenGoal dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour OpenGoal dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour OpenGoal",
  "wsl.onboarding.opencodeReadyIn": "OpenGoal est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "OpenGoal est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez OpenGoal dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer OpenGoal",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenGoal non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'OpenGoal puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "OpenGoal n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez OpenGoal.",
  ...
  "toast.update.description":
    "Une nouvelle version d'OpenGoal ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe OpenGoal",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'OpenGoal ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "OpenGoal inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur OpenGoal dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour OpenGoal",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'OpenGoal sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si OpenGoal suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'OpenGoal.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'OpenGoal",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'OpenGoal.",
