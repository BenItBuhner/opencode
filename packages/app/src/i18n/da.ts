export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af OpenGoal",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i OpenGoal.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i OpenGoal.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i OpenGoal.",
  ...
  "dialog.server.description": "Skift hvilken OpenGoal-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker OpenGoal...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker OpenGoal i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer OpenGoal...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer OpenGoal i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater OpenGoal i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater OpenGoal",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenGoal er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før OpenGoal kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "OpenGoal kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter OpenGoal igen.",
  ...
  "toast.update.description": "En ny version af OpenGoal ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til OpenGoal-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, OpenGoal understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "OpenGoal inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør OpenGoal-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for OpenGoal",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan OpenGoal ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om OpenGoal følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan OpenGoal er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når OpenGoal starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af OpenGoal.",
