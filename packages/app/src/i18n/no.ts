...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av OpenGoal",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i OpenGoal.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i OpenGoal.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i OpenGoal.",
  ...
  "dialog.server.description": "Bytt hvilken OpenGoal-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av OpenGoal ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til OpenGoal-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at OpenGoal ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "OpenGoal inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør OpenGoal-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for OpenGoal",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan OpenGoal ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om OpenGoal skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan OpenGoal er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når OpenGoal starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av OpenGoal.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker OpenGoal...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker OpenGoal i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer OpenGoal...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer OpenGoal i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater OpenGoal i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater OpenGoal",
  "wsl.onboarding.opencodeReadyIn": "OpenGoal er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "OpenGoal er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer OpenGoal i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenGoal er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før OpenGoal kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "OpenGoal kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter OpenGoal på nytt.",
