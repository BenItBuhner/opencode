export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por OpenGoal",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en OpenGoal.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en OpenGoal.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en OpenGoal.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de OpenGoal se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando OpenGoal...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando OpenGoal en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando OpenGoal...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando OpenGoal en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza OpenGoal en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar OpenGoal",
  "wsl.onboarding.opencodeReadyIn": "OpenGoal está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "OpenGoal está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala OpenGoal en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar OpenGoal",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenGoal no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que OpenGoal pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "OpenGoal no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir OpenGoal.",
  ...
  "toast.update.description": "Una nueva versión de OpenGoal ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de OpenGoal",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, OpenGoal no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "OpenGoal incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor OpenGoal dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para OpenGoal",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve OpenGoal en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si OpenGoal sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de OpenGoal.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia OpenGoal",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de OpenGoal.",
