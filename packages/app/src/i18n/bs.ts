export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje OpenGoal",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u OpenGoal-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u OpenGoal-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u OpenGoal-u.",
  ...
  "dialog.server.description": "Promijeni na koji se OpenGoal server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera OpenGoal...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera OpenGoal u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje OpenGoal...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje OpenGoal u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj OpenGoal u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj OpenGoal",
  "wsl.onboarding.opencodeReadyIn": "OpenGoal je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "OpenGoal je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj OpenGoal u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj OpenGoal",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenGoal nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi OpenGoal mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "OpenGoal nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori OpenGoal.",
  ...
  "toast.update.description": "Nova verzija OpenGoal-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku OpenGoal timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: OpenGoal još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "OpenGoal uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni OpenGoal server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u OpenGoal-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako OpenGoal izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li OpenGoal prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu OpenGoal-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se OpenGoal pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju OpenGoal-a.",
