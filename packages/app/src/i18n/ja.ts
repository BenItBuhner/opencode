export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "OpenGoalが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、OpenGoalで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してOpenGoalで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、OpenGoalで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するOpenGoalサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "OpenGoalを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のOpenGoalを確認中...",
  "wsl.onboarding.updatingOpencode": "OpenGoalを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のOpenGoalを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のOpenGoalを更新してください。",
  "wsl.onboarding.updateOpencode": "OpenGoalを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のOpenGoalの準備ができました。",
  "wsl.onboarding.opencodeReady": "OpenGoalの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にOpenGoalをインストールしてください。",
  "wsl.onboarding.installOpencode": "OpenGoalをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenGoalがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OpenGoalでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、OpenGoalをもう一度開いてください。",
  ...
  "toast.update.description": "OpenGoalの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをOpenGoalチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: OpenGoalはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "OpenGoalには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でOpenGoalサーバーを実行します。",
  ...
  "settings.general.row.language.description": "OpenGoalの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのOpenGoalの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "OpenGoalがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "OpenGoalのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "OpenGoal の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "OpenGoal は最新バージョンです。",
