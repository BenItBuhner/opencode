export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من OpenGoal",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في OpenGoal.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في OpenGoal.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في OpenGoal.",
  ...
  "dialog.server.description": "تبديل خادم OpenGoal الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من OpenGoal...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من OpenGoal في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث OpenGoal...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث OpenGoal في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث OpenGoal في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث OpenGoal",
  "wsl.onboarding.opencodeReadyIn": "OpenGoal جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "OpenGoal جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت OpenGoal في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت OpenGoal",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenGoal غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن OpenGoal من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على OpenGoal التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح OpenGoal.",
  ...
  "toast.update.description": "نسخة جديدة من OpenGoal ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق OpenGoal",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن OpenGoal لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن OpenGoal نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم OpenGoal داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ OpenGoal",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور OpenGoal على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان OpenGoal يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة OpenGoal.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل OpenGoal",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من OpenGoal.",
