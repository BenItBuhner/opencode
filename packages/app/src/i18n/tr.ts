...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "OpenGoal tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve OpenGoal'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak OpenGoal'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak OpenGoal'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi OpenGoal sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "OpenGoal kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde OpenGoal kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "OpenGoal güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde OpenGoal güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki OpenGoal'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "OpenGoal'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde OpenGoal hazır.",
  "wsl.onboarding.opencodeReady": "OpenGoal hazır.",
  "wsl.onboarding.installOpencodeIn": "OpenGoal'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "OpenGoal'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenGoal kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OpenGoal'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "OpenGoal bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından OpenGoal'u tekrar açın.",
  ...
  "toast.update.description": "OpenGoal'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı OpenGoal ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: OpenGoal henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "OpenGoal ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "OpenGoal Masaüstü",
  ...
  "settings.desktop.wsl.description": "OpenGoal sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "OpenGoal'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "OpenGoal'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "OpenGoal'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "OpenGoal'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "OpenGoal başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "OpenGoal'un en son sürümünü kullanıyorsunuz.",
