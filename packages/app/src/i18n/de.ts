...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von OpenGoal",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in OpenGoal zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in OpenGoal zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in OpenGoal zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den OpenGoal-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "OpenGoal wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "OpenGoal in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "OpenGoal wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "OpenGoal in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie OpenGoal in {{distro}}.",
  "wsl.onboarding.updateOpencode": "OpenGoal aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "OpenGoal ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "OpenGoal ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie OpenGoal in {{distro}}.",
  "wsl.onboarding.installOpencode": "OpenGoal installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenGoal nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor OpenGoal einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "OpenGoal konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann OpenGoal erneut.",
  ...
  "toast.update.description": "Eine neue Version von OpenGoal ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem OpenGoal-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: OpenGoal unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "OpenGoal enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "OpenGoal-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für OpenGoal ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie OpenGoal auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob OpenGoal dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von OpenGoal anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von OpenGoal automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von OpenGoal.",
