...
const TIPS: Tip[] = [
  ...
  "Create {highlight}opengoal.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.opengoal/commands/{/highlight} to define reusable custom prompts",
