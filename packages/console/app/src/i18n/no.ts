...
export const dict = {
  ...
  "app.meta.description": "OpenGoal - Den åpne kildekode kodingsagenten.",

  "home.title": "OpenGoal | Den åpne kildekode AI-kodingsagenten",
  ...
  "home.what.title": "Hva er OpenGoal?",
  "home.what.body": "OpenGoal er en åpen kildekode-agent som hjelper deg å skrive kode i terminal, IDE eller desktop.",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsytere og over <strong>{{commits}}</strong> commits, brukes OpenGoal av over <strong>{{monthlyUsers}}</strong> utviklere hver måned.",
  ...
  "home.privacy.body":
    "OpenGoal lagrer ikke koden din eller kontekstdata, slik at den kan fungere i personvernsensitive miljøer.",
  "home.privacy.learnMore": "Les mer om",
  "home.privacy.link": "personvern",

  "home.faq.q1": "Hva er OpenGoal?",
  "home.faq.a1":
    "OpenGoal er en åpen kildekode-agent som hjelper deg å skrive og kjøre kode med hvilken som helst AI-modell. Den er tilgjengelig som terminalgrensesnitt, desktop-app eller IDE-utvidelse.",
  "home.faq.q2": "Hvordan bruker jeg OpenGoal?",
  "home.faq.a2.before": "Den enkleste måten å komme i gang på er å lese",
  "home.faq.a2.link": "introen",
  "home.faq.q3": "Trenger jeg ekstra AI-abonnementer for å bruke OpenGoal?",
  "home.faq.a3.p1":
    "Ikke nødvendigvis. OpenGoal kommer med et sett gratis modeller du kan bruke uten å opprette en konto.",
  "home.faq.a3.p2.beforeZen": "I tillegg kan du bruke populære kodemodeller ved å opprette en",
  "home.faq.a3.p2.afterZen": " konto.",
  "home.faq.a3.p3":
    "Vi oppfordrer til å bruke Zen, men OpenGoal fungerer også med populære leverandører som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan til og med koble til dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruke mine eksisterende AI-abonnementer med OpenGoal?",
  "home.faq.a4.p1":
    "Ja, OpenGoal støtter abonnementer fra alle store leverandører. Du kan bruke Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot-abonnementer.",
  "home.faq.q5": "Kan jeg bare bruke OpenGoal i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke lenger! OpenGoal er nå tilgjengelig som en app for",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hva koster OpenGoal?",
  "home.faq.a6":
    "OpenGoal er 100% gratis å bruke. Det kommer også med et sett gratis modeller. Det kan være ekstra kostnader hvis du kobler til en annen leverandør.",
  ...
  "home.faq.q8": "Er OpenGoal åpen kildekode?",
  "home.faq.a8.p1": "Ja, OpenGoal er fullt open source. Kildekoden er offentlig på",
  ...
  "home.zenCta.body":
    "Zen gir deg tilgang til et håndplukket sett med AI-modeller som OpenGoal har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet på tvers av leverandører; bruk validerte modeller som fungerer.",
  ...
  "zen.hero.body":
    "Zen gir deg tilgang til et kuratert sett med AI-modeller som OpenGoal har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet; bruk validerte modeller som fungerer.",

  "zen.faq.q1": "Hva er OpenCode Zen?",
  "zen.faq.a1":
    "Zen er et kuratert sett med AI-modeller testet og benchmarked for kodeagenter, laget av teamet bak OpenGoal.",
  ...
  "zen.faq.a3":
    "Zen er ikke for profitt. Zen videreformidler kostnadene fra modellleverandørene direkte til deg. Jo mer Zen brukes, desto bedre priser kan OpenGoal forhandle og gi videre til deg.",
  ...
  "zen.faq.a4.p3":
    "For å dekke kostnader legger OpenGoal til bare et lite betalingsbehandlingsgebyr på $1.23 per $20 saldo-påfyll.",
  ...
  "zen.faq.a8":
    "Selv om Zen fungerer veldig bra med OpenGoal, kan du bruke Zen med hvilken som helst agent. Følg oppsettinstruksjonene i din foretrukne kodeagent.",
  ...
  "zen.problem.subtitle": "Vi fikser dette for alle, ikke bare OpenGoal-brukere.",
  ...
  "zen.how.body": "Selv om vi foreslår at du bruker Zen med OpenGoal, kan du bruke Zen med hvilken som helst agent.",
  ...
  "go.problem.body":
    "Vi fokuserer på å bringe OpenGoal-opplevelsen til så mange som mulig. OpenCode Go er et rimelig abonnement: $5 for den første måneden, deretter $10/måned. Det gir sjenerøse grenser og pålitelig tilgang til de mest kapable åpen kildekode-modellene.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go starter på $5 for den første måneden, deretter $10/måned. Du kan bruke det med OpenGoal eller hvilken som helst agent.",
  ...
  "black.meta.title": "OpenGoal Black | Få tilgang til verdens beste kodemodeller",
  "black.meta.description": "Få tilgang til Claude, GPT, Gemini og mer med OpenGoal Black-abonnementer.",
  ...
  "black.workspace.title": "OpenGoal Black | Velg arbeidsområde",
  ...
  "black.subscribe.success.title": "Du er på ventelisten for OpenGoal Black",
  ...
  "workspace.black.subscription.message": "Du abonnerer på OpenGoal Black for ${{plan}} per måned.",
  ...
  "workspace.black.waitlist.joined": "Du står på venteliste for OpenGoal Black-planen til ${{plan}} per måned.",
  "workspace.black.waitlist.ready": "Vi er klare til å melde deg på OpenGoal Black-planen til ${{plan}} per måned.",
  ...
  "workspace.lite.black.message":
    "Du abonnerer for øyeblikket på OpenGoal Black eller står på venteliste. Vennligst avslutt abonnementet først hvis du vil bytte til Go.",
  ...
  "download.title": "OpenGoal | Last ned",
  "download.meta.description": "Last ned OpenGoal for macOS, Windows og Linux",
  "download.hero.title": "Last ned OpenGoal Desktop",
  ...
  "download.faq.a3.beforeLocal":
    "Ikke nødvendigvis, men sannsynligvis. Du trenger et AI-abonnement hvis du vil koble OpenGoal til en betalt leverandør, selv om du kan jobbe med",
  ...
  "download.faq.a3.afterZen": ", fungerer OpenGoal med alle populære leverandører som OpenAI, Anthropic, xAI osv.",

  "download.faq.a5.p1": "OpenGoal er 100% gratis å bruke.",
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra kostnader kommer fra abonnementet ditt hos en modellleverandør. Selv om OpenGoal fungerer med enhver modellleverandør, anbefaler vi å bruke",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dataene og informasjonen din lagres bare når du oppretter delbare lenker i OpenGoal.",
  "download.faq.a6.p2.beforeShare": "Les mer om",
  "download.faq.a6.shareLink": "delingssider",

  "enterprise.title": "OpenGoal | Enterprise-løsninger for din organisasjon",
  "enterprise.meta.description": "Kontakt OpenGoal for enterprise-løsninger",
  "enterprise.hero.title": "Koden din er din",
  "enterprise.hero.body1":
    "OpenGoal opererer sikkert inne i organisasjonen din uten at data eller kontekst lagres, og uten lisensbegrensninger eller eierskapskrav. Start en prøveperiode med teamet ditt, og rull den deretter ut i hele organisasjonen ved å integrere den med SSO og din interne AI-gateway.",
  ...
  "enterprise.faq.q1": "Hva er OpenGoal Enterprise?",
  "enterprise.faq.a1":
    "OpenGoal Enterprise er for organisasjoner som vil sikre at koden og dataene deres aldri forlater infrastrukturen. Dette kan gjøres med en sentral konfigurasjon som integreres med SSO og intern AI-gateway.",
  "enterprise.faq.q2": "Hvordan kommer jeg i gang med OpenGoal Enterprise?",
  "enterprise.faq.a2":
    "Start enkelt med en intern prøveperiode med teamet ditt. OpenGoal lagrer som standard ikke koden din eller kontekstdata, noe som gjør det enkelt å komme i gang. Kontakt oss deretter for å diskutere priser og implementeringsalternativer.",
  ...
  "enterprise.faq.q4": "Er dataene mine sikre med OpenGoal Enterprise?",
  "enterprise.faq.a4":
    "Ja. OpenGoal lagrer ikke koden din eller kontekstdata. All behandling skjer lokalt eller gjennom direkte API-kall til AI-leverandøren din. Med sentral konfigurasjon og SSO-integrasjon forblir dataene dine sikre innenfor organisasjonens infrastruktur.",

  "brand.title": "OpenGoal | Merkevare",
  "brand.meta.description": "OpenGoal retningslinjer for merkevare",
  "brand.heading": "Retningslinjer for merkevare",
  "brand.subtitle": "Ressurser og assets som hjelper deg å jobbe med OpenGoal-brandet.",
  "brand.downloadAll": "Last ned alle assets",

  "changelog.title": "OpenGoal | Endringslogg",
  "changelog.meta.description": "Utgivelsesnotater og endringslogg for OpenGoal",
  "changelog.hero.title": "Endringslogg",
  "changelog.hero.subtitle": "Nye oppdateringer og forbedringer for OpenGoal",
