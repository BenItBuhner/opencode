...
export const RunCommand = effectCmd({
  command: "run [message..]",
  describe: "run OpenGoal with a message",
  ...
  builder: (yargs: Argv) =>
    yargs
      ...
      .option("attach", {
        type: "string",
        describe: "attach to a running OpenGoal server (e.g., http://localhost:4096)",
      })
      .option("password", {
        alias: ["p"],
        type: "string",
      ...
      .option("username", {
        alias: ["u"],
        type: "string",
        describe: "basic auth username (defaults to OPENGOAL_SERVER_USERNAME or 'opengoal')",
      })
      .option("dir", {
        type: "string",
