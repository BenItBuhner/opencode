export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von OpenGoal",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von OpenGoal wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
