export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію OpenGoal",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} OpenGoal завантажено. Бажаєте встановити її та перезапустити?",
