export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af OpenGoal",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af OpenGoal er blevet downloadet. Vil du installere den og genstarte?",
