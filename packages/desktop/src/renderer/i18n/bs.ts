export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju OpenGoal-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} OpenGoal-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
