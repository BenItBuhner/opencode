export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'OpenGoal",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'OpenGoal a été téléchargée. Voulez-vous l'installer et redémarrer ?",
