export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av OpenGoal",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av OpenGoal er lastet ned. Vil du installere den og starte på nytt?",
