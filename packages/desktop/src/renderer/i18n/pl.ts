export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji OpenGoal",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} OpenGoal. Czy chcesz ją zainstalować i uruchomić ponownie?",
